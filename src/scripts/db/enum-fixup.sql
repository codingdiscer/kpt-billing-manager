...
-- add the new column to visit
alter table visit_status_change add column visit_status text;

-- convert all existing data
update visit_status_change set visit_status = 'VISIT_CREATED' where visit_status_id = 0;
update visit_status_change set visit_status = 'SEEN_BY_THERAPIST' where visit_status_id = 1;
update visit_status_change set visit_status = 'PREPARED_FOR_BILLING' where visit_status_id = 2;
update visit_status_change set visit_status = 'BILLED_TO_INSURANCE' where visit_status_id = 3;
update visit_status_change set visit_status = 'REMITTANCE_ENTERED' where visit_status_id = 4;
update visit_status_change set visit_status = 'AWAITING_SECONDARY' where visit_status_id = 5;
update visit_status_change set visit_status = 'BILL_SENT_TO_PATIENT' where visit_status_id = 6;
update visit_status_change set visit_status = 'PAID_IN_FULL' where visit_status_id = 7;
