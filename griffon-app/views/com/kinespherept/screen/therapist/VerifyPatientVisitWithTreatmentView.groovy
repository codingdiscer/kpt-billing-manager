...
class VerifyPatientVisitWithTreatmentView extends BaseView {

    @MVCMember @Nonnull VerifyPatientVisitWithTreatmentController controller
    ...
    void initUI() {
        ...
        sceneManager.addScene(SceneDefinition.VERIFY_PATIENT_VISIT_WITH_TREATMENT, scene)
    }
